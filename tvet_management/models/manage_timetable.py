...
class ManageTimetable(models.Model):
    ...
    course_id = fields.Many2many('course.subject', string="Course Name", domain="[('school_department_id', '=', school_department_id)]", tracking=True)
...
class Monday(models.Model):
    ...
    start_time = fields.Float(string="Start Time", tracking=True)
    end_time = fields.Float(string="End Time", tracking=True)
    break_start_time = fields.Float(string="Break Start Time", tracking=True)
    break_end_time = fields.Float(string="Break End Time", tracking=True)
